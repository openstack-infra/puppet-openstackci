...
All parameters are documented inside the `../manifests/single_node_ci.pp`.
...
If you need to change the git url in your `project-config` in your `single_node_ci_hiera`, delete
/etc/project-config and puppet will reclone it from the new location.
...
(If you don't have an image yet, this is one of the first thing nodepool
