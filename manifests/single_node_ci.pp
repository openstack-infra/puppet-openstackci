...
#
# [*jenkins_version*]
#   This is a Jenkins version, possible versions include 'present',
#   'latest', or some specific. Default is '1.651', which is known as
#   the latest version to work well with Gearman plugin.
#
# [*gerrit_server*]
