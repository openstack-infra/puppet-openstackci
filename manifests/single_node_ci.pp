...
node default {
  ...
  $gerrit_ssh_host_key = hiera('gerrit_ssh_host_key', 'review.openstack.org,23.253.232.87,2001:4800:7815:104:3bc3:d7f6:ff03:bf5d b8:3c:72:82:d5:9e:59:43:54:11:ef:93:40:1f:6d:a5')
  $git_email = hiera('git_email', 'XXX')
  $git_name = hiera('git_name', 'XXX')
  $log_server = hiera('log_server', 'XXX')
  $logs_url_pattern = "http://${log_server}/{build.parameters[LOG_PATH]}"
