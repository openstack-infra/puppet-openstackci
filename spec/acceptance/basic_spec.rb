  ...
  if fact('osfamily') == 'Debian'
    ...
    context 'default parameters' do
      ...
      it 'should work with no errors' do
        ...
        apply_manifest(pp, :catch_failures => true, :debug => true, :verbose => true, :acceptable_exit_codes => [0,6])
        apply_manifest(pp, :catch_changes => true, :debug => true, :verbose => true, :acceptable_exit_codes => [0,6])
